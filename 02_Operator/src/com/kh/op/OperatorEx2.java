...
// 이 외 개발자가 실행하고자 하는 내용은 class 내부에 작성해야함
public class OperatorEx2 {
	...
	public static void 메서드3() {
		...
		System.out.print("num5 숫자를 입력하세요 : "); // (질문 보여짐)
		int num5 = sc.nextInt(); // (: 뒤에 나오는 입력 창)
	...
	public static void 메서드4() {
		Scanner sc = new Scanner(System.in);
		System.out.println("↓↓↓숫자를 입력하세요↓↓↓");
		// 키보드로 작성한 숫자가 num7로 들어올 수 있게 변수 선언
		System.out.print("num7 숫자를 입력하세요 : ");
		double num7 = sc.nextDouble();
		// 키보드로 작성한 숫자가 num8로 들어올 수 있게 변수 선언
