...
public class ImageCopy {
	public static void main(String[] args) {
		...
		String 원본이미지 = "src/com/kh/imageEx/healing.jpg"; //ctrl alt 화살표 아래
		String 복사이미지 = "src/com/kh/imageEx/healing_cute.jpg"; //ctrl alt 화살표 아래
		
		//FileInputStram OutputStream을 사용해서 읽고 쓰고 합시다!
		try {
