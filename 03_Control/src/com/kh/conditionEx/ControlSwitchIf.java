...
public class ControlSwitchIf {
	...
	public static void takeAtaxi() {
		...
		if(money >= 3000) {
			System.out.println("택시를 탈 예정인가요? (예/아니오)");
	...
	/*
		...
		60점 미만일 경우 F 학점
			-> F 학점일 때 재수강 하시겠습니까? (Yes/No)
				만약에 Yes No 외의 값이 나올 수 있기 때문에
				case YES : case yes: case Yes:
	*/
	
	public static void whyScore() {
		Scanner sc = new Scanner(System.in);
		System.out.print("사용자의 점수를 입력하세요 : ");
		...
		if (score >= 90) {
			...
			switch(reClass) { 
				...
				case "No" : case "NO": case "no":
					System.out.println("재수강을 신청하지 않았습니다.");
					break;
