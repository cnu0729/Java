...
/*
 ...
 Calender : 날짜와 시간을 조작하는데 사용되는 추상클래스
 Gregorian Calender = 그레고리력을 사용해서 날짜와 시간을 계산
 SimpleDateFormet = 날짜와 시간을 형식으로 보여주고 그것을 출력
 LocalDate
...
public class DateEx {
	public static void main(String[] args) {
		...
		*/
		...
		GregorianCalendar 그레고리안2 = new GregorianCalendar(2024, 4, 23); //2024년 5월 23일로 될 것
		...
		/*
		 ...
		 년 : y year
		 월 : M Month (분이랑 첫 글자가 m인 것이 같기 때문에 월은 대문자 M 사용)
		 일 : d day
