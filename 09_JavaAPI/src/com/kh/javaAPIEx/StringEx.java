...
/*
 ...
 subString = 내가 시작하고 싶은 숫자부터 끝내고 싶은 숫자값을 지정해서 변경할 
 수 있음
...
public class StringEx {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("공백제거 됐나요? " +공백제거); //중간공백 제거X
		
		//split splice replace match charAt
		
		//5. split 문자열을 특정 구분자를 기준으로 분할해서 문자열 배열로 변환
