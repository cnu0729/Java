...
public class OperatorPre {
	...
	public static void practice2() { // 키보드로 정보 입력받기 + 남/여 확인
		...
		// charAt을 사용해서 문자열 위치를 읽어오는 작업을 진행
		// 시스템으로 예를 들면
		// System - out - println
	...
	세 과목에 대한 합계(국+영+수)와 평균(합계/3.0)을 구하라.
	*/
	...
	/*
	 *  System.out.print("줄 바꿈 없이 가로로 출력")
	 *  		   println("다 출력한 다음에 다음 줄에서 작성하기 Enter")
	...
	/*
	 ...
	 false 모두 같으면 true 출력
	*/
	public static void practice4() {
		Scanner sc = new Scanner(System.in);
		
		System.out.print("Num1의 값을 입력하세요 : ");
		int Num1 = sc.nextInt(); // 정수로 Num1의 값을 받음
		
		System.out.print("Num2의 값을 입력하세요 : ");
		int Num2 = sc.nextInt(); // 정수로 Num2의 값을 받음
		
		// 모두 다르면 !=
		// boolean 참 거짓
		boolean result1 = Num1 != Num2; // 두 수 값이 다르면 참
	...
	/*
	3개의 수를 키보드로 입력받아
	입력 받은 수가 모두 같으면 true, 아니면 false
	*/
	public static void practice5() {
		...
		//   (false)  &&  (false)  =  false
		//									┌	true  ┐ (ㅂ + 한자키보드 -> ┌┐)
		// 					num1 이랑 num2가 같을 때 && num2랑 num3가 같을 때
