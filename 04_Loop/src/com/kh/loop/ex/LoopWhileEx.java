...
public class LoopWhileEx {
	...
	*/
	public static void method1() {
		while(true) {
			...
			int menu = sc.nextInt(); // 메뉴 입력하는 숫자 공간
	...
	/*
	 ...
	 만약에 1 미만의 숫자가 입력됐다면 1 이상의 숫자를 입력해주세요 출력하기
	*/
	...
	*/
	...
	public static void iLovePork() {
		...
		System.out.println("안냐세염~ 탕수육가게임돵*^^*");
		int tangsuyuk = 10000;
		Scanner sc = new Scanner(System.in);
		System.out.print("현재 가진 돈을 입력해주세요 : ");
		...
		System.out.println("주문이 완료되었습니다. 거스름돈은 "+(myMoney - tangsuyuk)+ " 입니다.");
		// 다시 입금해주세요.
